      ...
      <div className="h-16 border-b border-[#2B3139] bg-[#181C25] flex items-center px-6 shrink-0 z-30 justify-between">
        <div className="flex items-center space-x-8">
            ...
            <div className="flex flex-col">
                ...
                <span className={`text-lg font-black tabular-nums ${selectedAsset.change24h >= 0 ? 'text-emerald-500' : 'text-rose-500'}`}>
        ...
        <div className="flex items-center space-x-4 shrink-0">
          <div className="flex items-center space-x-3 bg-indigo-900/10 px-5 py-2 rounded-xl border border-indigo-500/20">
             <div className="w-2 h-2 rounded-full bg-indigo-500 animate-pulse"></div>
             <span className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.2em]">Asset_Telemetry</span>
          </div>
        </div>
      </div>
